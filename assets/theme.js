...
//*************WSDEV
/*$( document ).ready(function() {
  $(".wsdev select").prop('selectedIndex',27).mousedown();
  for (i=1; i <= 24; i++) {
    $(".wsdev select option[value=1-"+i+"]").remove();
  }
  $(".wsdev select").prop('selectedIndex',3).mousedown();
  $(".wsdev button.btn.button.bold-ro__custombutton-1524764704883").click(function(){
    $(".wsdev select").prop('selectedIndex',3).mousedown();
  });
}); */
